...
<MODEL>
  ...
  <MODEL_INFO>
    ...
    <DESCRIPTIONS>
      <DESCRIPTION ID="1">Utility</DESCRIPTION>
    </DESCRIPTIONS>
  </MODEL_INFO>
  <CURRENCIES />
  <MODEL_ADDINS>
  ...
  <ROLLING_STMT_SETTINGS>
    ...
    <SUMMED_ITEMS>
      ...
      <SUMMED_ITEM TYPE="2" ID="175" />
      <SUMMED_ITEM TYPE="2" ID="215" />
    </SUMMED_ITEMS>
    <VALUE_ITEMS>
      <VALUE_ITEM TYPE="2" ID="221" VALUE="0" USEFIRSTSTATEMENT="False" />
      <VALUE_ITEM TYPE="2" ID="222" VALUE="0" USEFIRSTSTATEMENT="False" />
      <VALUE_ITEM TYPE="2" ID="223" VALUE="0" USEFIRSTSTATEMENT="False" />
      <VALUE_ITEM TYPE="2" ID="225" VALUE="0" USEFIRSTSTATEMENT="False" />
      <VALUE_ITEM TYPE="2" ID="235" VALUE="0" USEFIRSTSTATEMENT="False" />
      <VALUE_ITEM TYPE="2" ID="249" VALUE="0" USEFIRSTSTATEMENT="False" />
    </VALUE_ITEMS>
  </ROLLING_STMT_SETTINGS>
  <RMA_MAPPINGS />
  <RA_MAPPINGS />
