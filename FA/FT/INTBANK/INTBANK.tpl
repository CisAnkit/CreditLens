...
<MODEL>
  ...
  <MODEL_INFO>
    ...
    <NAMES>
      <NAME ID="1">INTBANK</NAME>
    </NAMES>
    <DESCRIPTIONS>
      <DESCRIPTION ID="1">International Bank</DESCRIPTION>
    </DESCRIPTIONS>
  </MODEL_INFO>
  <CURRENCIES />
  <MODEL_ADDINS>
  ...
  <UNKNOWN_MODEL_PROPERTIES>
    ...
    <UNKNOWN_MODEL_PROPERTY ID="MODELCONFIGURATION"><![CDATA[]]></UNKNOWN_MODEL_PROPERTY>
    <UNKNOWN_MODEL_PROPERTY ID="CurrencyConstID"><![CDATA[7]]></UNKNOWN_MODEL_PROPERTY>
    <UNKNOWN_MODEL_PROPERTY ID="DetailedFinancialGroup"><![CDATA[5]]></UNKNOWN_MODEL_PROPERTY>
  ...
  <STMT_CONSTANTS>
    <STMT_CONSTANT ID="1" HIDDEN="False" READONLY="False" LENGTH="30" REQUIRED="False" DISPLAY="True">
      ...
      <STMT_CONST_ATTRIBUTE ID="1">&lt;as&gt;&lt;a id="" v=""/&gt;&lt;a id="Unqualif'd" v="Unqualif&amp;apos;d"/&gt;&lt;a id="Qualified" v="Qualified"/&gt;&lt;a id="Reviewed" v="Reviewed"/&gt;&lt;a id="Compiled" v="Compiled"/&gt;&lt;a id="Co.Prep'd" v="Co.Prep&amp;apos;d"/&gt;&lt;a id="Tax Return" v="Tax Return"/&gt;&lt;a id="Projection" v="Projection"/&gt;&lt;hd v="Unqualif&amp;apos;d"/&gt;&lt;pd v="Projection"/&gt;&lt;rscd v="Co.Prep&amp;apos;d"/&gt;&lt;/as&gt;</STMT_CONST_ATTRIBUTE>
    ...
    <STMT_CONSTANT ID="4" HIDDEN="False" READONLY="False" LENGTH="30" REQUIRED="False" DISPLAY="True">
      ...
      <STMT_CONST_ATTRIBUTE ID="1">&lt;as&gt;&lt;a id="" v=""/&gt;&lt;a id="Annual" v="Annual"/&gt;&lt;a id="Monthly" v="Monthly"/&gt;&lt;a id="Quarterly" v="Quarterly"/&gt;&lt;a id="FY-To-Date" v="FY-To-Date"/&gt;&lt;a id="Rolling Stmt" v="Rolling Stmt"/&gt;&lt;hd v="Annual"/&gt;&lt;pd v=""/&gt;&lt;rscd v="Rolling Stmt"/&gt;&lt;/as&gt;</STMT_CONST_ATTRIBUTE>
  ...
  <ROLLING_STMT_SETTINGS>
    ...
    <SUMMED_ITEMS>
      ...
      <SUMMED_ITEM TYPE="2" ID="143" />
      <SUMMED_ITEM TYPE="2" ID="145" />
    </SUMMED_ITEMS>
    <VALUE_ITEMS>
      <VALUE_ITEM TYPE="2" ID="168" VALUE="0" USEFIRSTSTATEMENT="False" />
      <VALUE_ITEM TYPE="2" ID="174" VALUE="0" USEFIRSTSTATEMENT="False" />
      <VALUE_ITEM TYPE="2" ID="176" VALUE="0" USEFIRSTSTATEMENT="False" />
      <VALUE_ITEM TYPE="2" ID="151" VALUE="0" USEFIRSTSTATEMENT="False" />
      <VALUE_ITEM TYPE="2" ID="170" VALUE="0" USEFIRSTSTATEMENT="False" />
      <VALUE_ITEM TYPE="2" ID="149" VALUE="0" USEFIRSTSTATEMENT="False" />
      <VALUE_ITEM TYPE="2" ID="172" VALUE="0" USEFIRSTSTATEMENT="False" />
    </VALUE_ITEMS>
  </ROLLING_STMT_SETTINGS>
  <RMA_MAPPINGS />
  <RA_MAPPINGS />
