...
{
	/// <summary>
	/// Summary description for USER_DEF_CRED_COMP.
	/// </summary>
	public class USER_DEF_CRED_COMP: FinancialAnalyst.IReport
	{
		public void Execute(ReportGenerator RG)
		{
			...
			{
				if (((a.CreditCompliance == true) && (a.Print == true))&& ((RG.UDA(a.Id) is Calc)||(RG.UDA(a.Id) is int) || (RG.UDA(a.Id) is double)))
				{
					hasItems = true;
					break;
				}
			...
			if(hasItems)
				...
				Utility.PrintLabel(RG, rm.GetString("udaComMsg"));
